...
/* interface __MIDL_itf_IVsSccProjectEnlistmentChoice_0000 */
/* [local] */ 
...
extern RPC_IF_HANDLE __MIDL_itf_IVsSccProjectEnlistmentChoice_0000_v0_0_c_ifspec;
extern RPC_IF_HANDLE __MIDL_itf_IVsSccProjectEnlistmentChoice_0000_v0_0_s_ifspec;
...
EXTERN_C const IID IID_IVsSccProjectEnlistmentChoice;
    ...
    public:
        virtual HRESULT STDMETHODCALLTYPE GetEnlistmentChoice( 
            /* [retval][out] */ VSSCCENLISTMENTCHOICE *pvscecEnlistmentChoice) = 0;
    ...
    typedef struct IVsSccProjectEnlistmentChoiceVtbl
    {
        ...
        HRESULT ( STDMETHODCALLTYPE *GetEnlistmentChoice )( 
            IVsSccProjectEnlistmentChoice * This,
            /* [retval][out] */ VSSCCENLISTMENTCHOICE *pvscecEnlistmentChoice);
...
HRESULT STDMETHODCALLTYPE IVsSccProjectEnlistmentChoice_GetEnlistmentChoice_Proxy( 
    IVsSccProjectEnlistmentChoice * This,
    /* [retval][out] */ VSSCCENLISTMENTCHOICE *pvscecEnlistmentChoice);


void __RPC_STUB IVsSccProjectEnlistmentChoice_GetEnlistmentChoice_Stub(
    IRpcStubBuffer *This,
