...
/* interface __MIDL_itf_IVsTrackProjectDocumentsEvents2_0000 */
/* [local] */ 
...
extern RPC_IF_HANDLE __MIDL_itf_IVsTrackProjectDocumentsEvents2_0000_v0_0_c_ifspec;
extern RPC_IF_HANDLE __MIDL_itf_IVsTrackProjectDocumentsEvents2_0000_v0_0_s_ifspec;
...
EXTERN_C const IID IID_IVsTrackProjectDocumentsEvents2;
    ...
    public:
        ...
        virtual HRESULT STDMETHODCALLTYPE OnAfterAddFilesEx( 
            /* [in] */ int cProjects,
            /* [in] */ int cFiles,
            /* [size_is][in] */ IVsProject *rgpProjects[  ],
            /* [size_is][in] */ const int rgFirstIndices[  ],
            /* [size_is][in] */ const LPCOLESTR rgpszMkDocuments[  ],
...
HRESULT STDMETHODCALLTYPE IVsTrackProjectDocumentsEvents2_OnQueryAddFiles_Proxy( 
    IVsTrackProjectDocumentsEvents2 * This,
    /* [in] */ IVsProject *pProject,
    /* [in] */ int cFiles,
    /* [size_is][in] */ const LPCOLESTR rgpszMkDocuments[  ],
...
void __RPC_STUB IVsTrackProjectDocumentsEvents2_OnQueryAddFiles_Stub(
    IRpcStubBuffer *This,
...
HRESULT STDMETHODCALLTYPE IVsTrackProjectDocumentsEvents2_OnAfterAddFilesEx_Proxy( 
    IVsTrackProjectDocumentsEvents2 * This,
    /* [in] */ int cProjects,
    /* [in] */ int cFiles,
    /* [size_is][in] */ IVsProject *rgpProjects[  ],
...
void __RPC_STUB IVsTrackProjectDocumentsEvents2_OnAfterAddFilesEx_Stub(
    IRpcStubBuffer *This,
    IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
...
HRESULT STDMETHODCALLTYPE IVsTrackProjectDocumentsEvents2_OnAfterAddDirectoriesEx_Proxy( 
    IVsTrackProjectDocumentsEvents2 * This,
    /* [in] */ int cProjects,
    /* [in] */ int cDirectories,
    /* [size_is][in] */ IVsProject *rgpProjects[  ],
...
void __RPC_STUB IVsTrackProjectDocumentsEvents2_OnAfterAddDirectoriesEx_Stub(
    IRpcStubBuffer *This,
    IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
...
HRESULT STDMETHODCALLTYPE IVsTrackProjectDocumentsEvents2_OnAfterRemoveFiles_Proxy( 
    IVsTrackProjectDocumentsEvents2 * This,
    /* [in] */ int cProjects,
    /* [in] */ int cFiles,
    /* [size_is][in] */ IVsProject *rgpProjects[  ],
...
void __RPC_STUB IVsTrackProjectDocumentsEvents2_OnAfterRemoveFiles_Stub(
    IRpcStubBuffer *This,
    IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
...
HRESULT STDMETHODCALLTYPE IVsTrackProjectDocumentsEvents2_OnAfterRemoveDirectories_Proxy( 
    IVsTrackProjectDocumentsEvents2 * This,
    /* [in] */ int cProjects,
    /* [in] */ int cDirectories,
    /* [size_is][in] */ IVsProject *rgpProjects[  ],
...
void __RPC_STUB IVsTrackProjectDocumentsEvents2_OnAfterRemoveDirectories_Stub(
    IRpcStubBuffer *This,
    IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
...
HRESULT STDMETHODCALLTYPE IVsTrackProjectDocumentsEvents2_OnQueryRenameFiles_Proxy( 
    IVsTrackProjectDocumentsEvents2 * This,
    /* [in] */ IVsProject *pProject,
    /* [in] */ int cFiles,
    /* [size_is][in] */ const LPCOLESTR rgszMkOldNames[  ],
...
void __RPC_STUB IVsTrackProjectDocumentsEvents2_OnQueryRenameFiles_Stub(
    IRpcStubBuffer *This,
    IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
...
HRESULT STDMETHODCALLTYPE IVsTrackProjectDocumentsEvents2_OnAfterRenameFiles_Proxy( 
    IVsTrackProjectDocumentsEvents2 * This,
    /* [in] */ int cProjects,
    /* [in] */ int cFiles,
    /* [size_is][in] */ IVsProject *rgpProjects[  ],
...
void __RPC_STUB IVsTrackProjectDocumentsEvents2_OnAfterRenameFiles_Stub(
    IRpcStubBuffer *This,
    IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
...
HRESULT STDMETHODCALLTYPE IVsTrackProjectDocumentsEvents2_OnQueryRenameDirectories_Proxy( 
    IVsTrackProjectDocumentsEvents2 * This,
    /* [in] */ IVsProject *pProject,
    /* [in] */ int cDirs,
    /* [size_is][in] */ const LPCOLESTR rgszMkOldNames[  ],
...
void __RPC_STUB IVsTrackProjectDocumentsEvents2_OnQueryRenameDirectories_Stub(
    IRpcStubBuffer *This,
    IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
...
HRESULT STDMETHODCALLTYPE IVsTrackProjectDocumentsEvents2_OnAfterRenameDirectories_Proxy( 
    IVsTrackProjectDocumentsEvents2 * This,
    /* [in] */ int cProjects,
    /* [in] */ int cDirs,
    /* [size_is][in] */ IVsProject *rgpProjects[  ],
...
void __RPC_STUB IVsTrackProjectDocumentsEvents2_OnAfterRenameDirectories_Stub(
    IRpcStubBuffer *This,
    IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
...
HRESULT STDMETHODCALLTYPE IVsTrackProjectDocumentsEvents2_OnQueryAddDirectories_Proxy( 
    IVsTrackProjectDocumentsEvents2 * This,
    /* [in] */ IVsProject *pProject,
    /* [in] */ int cDirectories,
    /* [size_is][in] */ const LPCOLESTR rgpszMkDocuments[  ],
...
void __RPC_STUB IVsTrackProjectDocumentsEvents2_OnQueryAddDirectories_Stub(
    IRpcStubBuffer *This,
    IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
...
HRESULT STDMETHODCALLTYPE IVsTrackProjectDocumentsEvents2_OnQueryRemoveFiles_Proxy( 
    IVsTrackProjectDocumentsEvents2 * This,
    /* [in] */ IVsProject *pProject,
    /* [in] */ int cFiles,
    /* [size_is][in] */ const LPCOLESTR rgpszMkDocuments[  ],
...
void __RPC_STUB IVsTrackProjectDocumentsEvents2_OnQueryRemoveFiles_Stub(
    IRpcStubBuffer *This,
    IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
...
HRESULT STDMETHODCALLTYPE IVsTrackProjectDocumentsEvents2_OnQueryRemoveDirectories_Proxy( 
    IVsTrackProjectDocumentsEvents2 * This,
    /* [in] */ IVsProject *pProject,
    /* [in] */ int cDirectories,
    /* [size_is][in] */ const LPCOLESTR rgpszMkDocuments[  ],
...
void __RPC_STUB IVsTrackProjectDocumentsEvents2_OnQueryRemoveDirectories_Stub(
    IRpcStubBuffer *This,
    IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
...
HRESULT STDMETHODCALLTYPE IVsTrackProjectDocumentsEvents2_OnAfterSccStatusChanged_Proxy( 
    IVsTrackProjectDocumentsEvents2 * This,
    /* [in] */ int cProjects,
    /* [in] */ int cFiles,
    /* [size_is][in] */ IVsProject *rgpProjects[  ],
...
void __RPC_STUB IVsTrackProjectDocumentsEvents2_OnAfterSccStatusChanged_Stub(
    IRpcStubBuffer *This,
    IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
