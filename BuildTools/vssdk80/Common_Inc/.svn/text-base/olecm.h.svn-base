...
/* interface __MIDL_itf_olecm_0000 */
/* [local] */ 
...
extern RPC_IF_HANDLE __MIDL_itf_olecm_0000_v0_0_c_ifspec;
extern RPC_IF_HANDLE __MIDL_itf_olecm_0000_v0_0_s_ifspec;
...
BOOL STDMETHODCALLTYPE IOleComponent_FReserved1_Proxy( 
    IOleComponent * This,
    /* [in] */ DWORD dwReserved,
    /* [in] */ UINT message,
    /* [in] */ WPARAM wParam,
...
void __RPC_STUB IOleComponent_FReserved1_Stub(
    IRpcStubBuffer *This,
...
BOOL STDMETHODCALLTYPE IOleComponent_FPreTranslateMessage_Proxy( 
    IOleComponent * This,
    /* [out][in] */ MSG *pMsg);


void __RPC_STUB IOleComponent_FPreTranslateMessage_Stub(
    IRpcStubBuffer *This,
    IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
...
void STDMETHODCALLTYPE IOleComponent_OnEnterState_Proxy( 
    IOleComponent * This,
    /* [in] */ OLECSTATE uStateID,
    /* [in] */ BOOL fEnter);


void __RPC_STUB IOleComponent_OnEnterState_Stub(
    IRpcStubBuffer *This,
    IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
...
void STDMETHODCALLTYPE IOleComponent_OnAppActivate_Proxy( 
    IOleComponent * This,
    /* [in] */ BOOL fActive,
    /* [in] */ DWORD dwOtherThreadID);


void __RPC_STUB IOleComponent_OnAppActivate_Stub(
    IRpcStubBuffer *This,
    IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
...
void STDMETHODCALLTYPE IOleComponent_OnLoseActivation_Proxy( 
    IOleComponent * This);


void __RPC_STUB IOleComponent_OnLoseActivation_Stub(
    IRpcStubBuffer *This,
    IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
...
void STDMETHODCALLTYPE IOleComponent_OnActivationChange_Proxy( 
    IOleComponent * This,
    /* [in] */ IOleComponent *pic,
    /* [in] */ BOOL fSameComponent,
    /* [in] */ const OLECRINFO *pcrinfo,
...
void __RPC_STUB IOleComponent_OnActivationChange_Stub(
    IRpcStubBuffer *This,
    IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
...
BOOL STDMETHODCALLTYPE IOleComponent_FDoIdle_Proxy( 
    IOleComponent * This,
    /* [in] */ OLEIDLEF grfidlef);


void __RPC_STUB IOleComponent_FDoIdle_Stub(
    IRpcStubBuffer *This,
    IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
...
BOOL STDMETHODCALLTYPE IOleComponent_FContinueMessageLoop_Proxy( 
    IOleComponent * This,
    /* [in] */ OLELOOP uReason,
    /* [in] */ void *pvLoopData,
    /* [in] */ MSG *pMsgPeeked);
...
void __RPC_STUB IOleComponent_FContinueMessageLoop_Stub(
    IRpcStubBuffer *This,
    IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
...
BOOL STDMETHODCALLTYPE IOleComponent_FQueryTerminate_Proxy( 
    IOleComponent * This,
    /* [in] */ BOOL fPromptUser);


void __RPC_STUB IOleComponent_FQueryTerminate_Stub(
    IRpcStubBuffer *This,
    IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
...
void STDMETHODCALLTYPE IOleComponent_Terminate_Proxy( 
    IOleComponent * This);


void __RPC_STUB IOleComponent_Terminate_Stub(
    IRpcStubBuffer *This,
    IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
...
HWND STDMETHODCALLTYPE IOleComponent_HwndGetWindow_Proxy( 
    IOleComponent * This,
    /* [in] */ OLECWINDOW dwWhich,
    /* [in] */ DWORD dwReserved);


void __RPC_STUB IOleComponent_HwndGetWindow_Stub(
    IRpcStubBuffer *This,
    IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
...
HRESULT STDMETHODCALLTYPE IOleComponentManager_QueryService_Proxy( 
    IOleComponentManager * This,
    /* [in] */ REFGUID guidService,
    /* [in] */ REFIID iid,
    /* [out] */ void **ppvObj);
...
void __RPC_STUB IOleComponentManager_QueryService_Stub(
    IRpcStubBuffer *This,
    IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
...
BOOL STDMETHODCALLTYPE IOleComponentManager_FReserved1_Proxy( 
    IOleComponentManager * This,
    /* [in] */ DWORD dwReserved,
    /* [in] */ UINT message,
    /* [in] */ WPARAM wParam,
...
void __RPC_STUB IOleComponentManager_FReserved1_Stub(
    IRpcStubBuffer *This,
    IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
...
BOOL STDMETHODCALLTYPE IOleComponentManager_FRegisterComponent_Proxy( 
    IOleComponentManager * This,
    /* [in] */ IOleComponent *piComponent,
    /* [in] */ const OLECRINFO *pcrinfo,
    /* [out] */ DWORD_PTR *pdwComponentID);
...
void __RPC_STUB IOleComponentManager_FRegisterComponent_Stub(
    IRpcStubBuffer *This,
    IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
...
BOOL STDMETHODCALLTYPE IOleComponentManager_FRevokeComponent_Proxy( 
    IOleComponentManager * This,
    /* [in] */ DWORD_PTR dwComponentID);


void __RPC_STUB IOleComponentManager_FRevokeComponent_Stub(
    IRpcStubBuffer *This,
    IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
...
BOOL STDMETHODCALLTYPE IOleComponentManager_FUpdateComponentRegistration_Proxy( 
    IOleComponentManager * This,
    /* [in] */ DWORD_PTR dwComponentID,
    /* [in] */ const OLECRINFO *pcrinfo);


void __RPC_STUB IOleComponentManager_FUpdateComponentRegistration_Stub(
    IRpcStubBuffer *This,
    IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
...
BOOL STDMETHODCALLTYPE IOleComponentManager_FOnComponentActivate_Proxy( 
    IOleComponentManager * This,
    /* [in] */ DWORD_PTR dwComponentID);


void __RPC_STUB IOleComponentManager_FOnComponentActivate_Stub(
    IRpcStubBuffer *This,
    IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
...
BOOL STDMETHODCALLTYPE IOleComponentManager_FSetTrackingComponent_Proxy( 
    IOleComponentManager * This,
    /* [in] */ DWORD_PTR dwComponentID,
    /* [in] */ BOOL fTrack);


void __RPC_STUB IOleComponentManager_FSetTrackingComponent_Stub(
    IRpcStubBuffer *This,
    IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
...
void STDMETHODCALLTYPE IOleComponentManager_OnComponentEnterState_Proxy( 
    IOleComponentManager * This,
    /* [in] */ DWORD_PTR dwComponentID,
    /* [in] */ OLECSTATE uStateID,
    /* [in] */ OLECCONTEXT uContext,
...
void __RPC_STUB IOleComponentManager_OnComponentEnterState_Stub(
    IRpcStubBuffer *This,
    IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
...
BOOL STDMETHODCALLTYPE IOleComponentManager_FOnComponentExitState_Proxy( 
    IOleComponentManager * This,
    /* [in] */ DWORD_PTR dwComponentID,
    /* [in] */ OLECSTATE uStateID,
    /* [in] */ OLECCONTEXT uContext,
...
void __RPC_STUB IOleComponentManager_FOnComponentExitState_Stub(
    IRpcStubBuffer *This,
    IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
...
BOOL STDMETHODCALLTYPE IOleComponentManager_FInState_Proxy( 
    IOleComponentManager * This,
    /* [in] */ OLECSTATE uStateID,
    /* [in] */ void *pvoid);


void __RPC_STUB IOleComponentManager_FInState_Stub(
    IRpcStubBuffer *This,
    IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
...
BOOL STDMETHODCALLTYPE IOleComponentManager_FContinueIdle_Proxy( 
    IOleComponentManager * This);


void __RPC_STUB IOleComponentManager_FContinueIdle_Stub(
    IRpcStubBuffer *This,
    IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
...
BOOL STDMETHODCALLTYPE IOleComponentManager_FPushMessageLoop_Proxy( 
    IOleComponentManager * This,
    /* [in] */ DWORD_PTR dwComponentID,
    /* [in] */ OLELOOP uReason,
    /* [in] */ void *pvLoopData);
...
void __RPC_STUB IOleComponentManager_FPushMessageLoop_Stub(
    IRpcStubBuffer *This,
    IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
...
BOOL STDMETHODCALLTYPE IOleComponentManager_FCreateSubComponentManager_Proxy( 
    IOleComponentManager * This,
    /* [in] */ IUnknown *piunkOuter,
    /* [in] */ IUnknown *piunkServProv,
    /* [in] */ REFIID riid,
...
void __RPC_STUB IOleComponentManager_FCreateSubComponentManager_Stub(
    IRpcStubBuffer *This,
    IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
...
BOOL STDMETHODCALLTYPE IOleComponentManager_FGetParentComponentManager_Proxy( 
    IOleComponentManager * This,
    /* [out] */ IOleComponentManager **ppicm);


void __RPC_STUB IOleComponentManager_FGetParentComponentManager_Stub(
    IRpcStubBuffer *This,
    IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
...
BOOL STDMETHODCALLTYPE IOleComponentManager_FGetActiveComponent_Proxy( 
    IOleComponentManager * This,
    /* [in] */ OLEGAC dwgac,
    /* [out] */ IOleComponent **ppic,
    /* [out][in] */ OLECRINFO *pcrinfo,
...
void __RPC_STUB IOleComponentManager_FGetActiveComponent_Stub(
    IRpcStubBuffer *This,
    IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
...
/* interface __MIDL_itf_olecm_0440 */
/* [local] */ 

EXTERN_C const IID SID_SOleComponentManager;


extern RPC_IF_HANDLE __MIDL_itf_olecm_0440_v0_0_c_ifspec;
extern RPC_IF_HANDLE __MIDL_itf_olecm_0440_v0_0_s_ifspec;
