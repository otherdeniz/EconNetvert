...
/* interface __MIDL_itf_textfind2_0000 */
/* [local] */ 

#pragma once


extern RPC_IF_HANDLE __MIDL_itf_textfind2_0000_v0_0_c_ifspec;
extern RPC_IF_HANDLE __MIDL_itf_textfind2_0000_v0_0_s_ifspec;
...
HRESULT STDMETHODCALLTYPE IVsFindTarget2_NavigateTo2_Proxy( 
    IVsFindTarget2 * This,
    /* [in] */ IVsTextSpanSet *pSpans,
    /* [in] */ enum _TextSelMode iSelMode);


void __RPC_STUB IVsFindTarget2_NavigateTo2_Stub(
    IRpcStubBuffer *This,
...
/* interface __MIDL_itf_textfind2_0673 */
/* [local] */ 

typedef /* [public] */ 
enum __MIDL___MIDL_itf_textfind2_0673_0001
...
extern RPC_IF_HANDLE __MIDL_itf_textfind2_0673_v0_0_c_ifspec;
extern RPC_IF_HANDLE __MIDL_itf_textfind2_0673_v0_0_s_ifspec;
...
HRESULT STDMETHODCALLTYPE IVsFindCancelDialog_LaunchDialog_Proxy( 
    IVsFindCancelDialog * This);


void __RPC_STUB IVsFindCancelDialog_LaunchDialog_Stub(
    IRpcStubBuffer *This,
    IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
...
HRESULT STDMETHODCALLTYPE IVsFindCancelDialog_QueryDialog_Proxy( 
    IVsFindCancelDialog * This,
    /* [out] */ BOOL *pfCancel);


void __RPC_STUB IVsFindCancelDialog_QueryDialog_Stub(
    IRpcStubBuffer *This,
    IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
...
HRESULT STDMETHODCALLTYPE IVsFindCancelDialog_CloseDialog_Proxy( 
    IVsFindCancelDialog * This);


void __RPC_STUB IVsFindCancelDialog_CloseDialog_Stub(
    IRpcStubBuffer *This,
    IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
