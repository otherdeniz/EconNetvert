...
#define IVsRegisterScciProvider_RegisterSourceControlProvider(This,guidProvider)	\
    (This)->lpVtbl -> RegisterSourceControlProvider(This,guidProvider)
...
HRESULT STDMETHODCALLTYPE IVsRegisterScciProvider_RegisterSourceControlProvider_Proxy( 
    IVsRegisterScciProvider * This,
    /* [in] */ GUID guidProvider);


void __RPC_STUB IVsRegisterScciProvider_RegisterSourceControlProvider_Stub(
    IRpcStubBuffer *This,
