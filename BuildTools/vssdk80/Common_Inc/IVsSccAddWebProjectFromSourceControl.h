...
/* interface __MIDL_itf_ivssccaddwebprojectfromsourcecontrol_0000 */
/* [local] */ 

#pragma once


extern RPC_IF_HANDLE __MIDL_itf_ivssccaddwebprojectfromsourcecontrol_0000_v0_0_c_ifspec;
extern RPC_IF_HANDLE __MIDL_itf_ivssccaddwebprojectfromsourcecontrol_0000_v0_0_s_ifspec;
...
HRESULT STDMETHODCALLTYPE IVsSccAddWebProjectFromSourceControl_IsAddWebProjectSupported_Proxy( 
    IVsSccAddWebProjectFromSourceControl * This,
    /* [out] */ VARIANT_BOOL *pfResult);


void __RPC_STUB IVsSccAddWebProjectFromSourceControl_IsAddWebProjectSupported_Stub(
    IRpcStubBuffer *This,
...
HRESULT STDMETHODCALLTYPE IVsSccAddWebProjectFromSourceControl_BrowseForServerLocation_Proxy( 
    IVsSccAddWebProjectFromSourceControl * This,
    /* [out] */ BSTR *pbstrLocationDescription,
    /* [out] */ BSTR *pbstrLocalPath,
    /* [out] */ BSTR *pbstrDatabasePath,
...
void __RPC_STUB IVsSccAddWebProjectFromSourceControl_BrowseForServerLocation_Stub(
    IRpcStubBuffer *This,
    IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
...
HRESULT STDMETHODCALLTYPE IVsSccAddWebProjectFromSourceControl_AddWebProjectFromSourceControl_Proxy( 
    IVsSccAddWebProjectFromSourceControl * This,
    /* [in] */ BSTR bstrLocalPath,
    /* [in] */ BSTR bstrDatabasePath,
    /* [in] */ BSTR bstrAuxiliarPath,
...
void __RPC_STUB IVsSccAddWebProjectFromSourceControl_AddWebProjectFromSourceControl_Stub(
    IRpcStubBuffer *This,
    IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
