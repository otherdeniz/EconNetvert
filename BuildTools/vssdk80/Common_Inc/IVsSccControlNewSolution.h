...
/* interface __MIDL_itf_ivsscccontrolnewsolution_0000 */
/* [local] */ 

#pragma once


extern RPC_IF_HANDLE __MIDL_itf_ivsscccontrolnewsolution_0000_v0_0_c_ifspec;
extern RPC_IF_HANDLE __MIDL_itf_ivsscccontrolnewsolution_0000_v0_0_s_ifspec;
...
HRESULT STDMETHODCALLTYPE IVsSccControlNewSolution_AddNewSolutionToSourceControl_Proxy( 
    IVsSccControlNewSolution * This);


void __RPC_STUB IVsSccControlNewSolution_AddNewSolutionToSourceControl_Stub(
    IRpcStubBuffer *This,
...
HRESULT STDMETHODCALLTYPE IVsSccControlNewSolution_GetDisplayStringForAction_Proxy( 
    IVsSccControlNewSolution * This,
    /* [out] */ BSTR *pbstrActionName);


void __RPC_STUB IVsSccControlNewSolution_GetDisplayStringForAction_Stub(
    IRpcStubBuffer *This,
    IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
