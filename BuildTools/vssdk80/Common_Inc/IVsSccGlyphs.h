...
/* interface __MIDL_itf_ivssccglyphs_0000 */
/* [local] */ 

#pragma once


extern RPC_IF_HANDLE __MIDL_itf_ivssccglyphs_0000_v0_0_c_ifspec;
extern RPC_IF_HANDLE __MIDL_itf_ivssccglyphs_0000_v0_0_s_ifspec;
...
EXTERN_C const IID IID_IVsSccGlyphs;
    ...
    public:
        virtual HRESULT STDMETHODCALLTYPE GetCustomGlyphList( 
            /* [in] */ ULONG BaseIndex,
            /* [out] */ PDWORD_PTR pdwImageListHandle) = 0;
...
HRESULT STDMETHODCALLTYPE IVsSccGlyphs_GetCustomGlyphList_Proxy( 
    IVsSccGlyphs * This,
    /* [in] */ ULONG BaseIndex,
    /* [out] */ PDWORD_PTR pdwImageListHandle);


void __RPC_STUB IVsSccGlyphs_GetCustomGlyphList_Stub(
    IRpcStubBuffer *This,
