...
/* interface __MIDL_itf_ivssccprovider_0000 */
/* [local] */ 

#pragma once


extern RPC_IF_HANDLE __MIDL_itf_ivssccprovider_0000_v0_0_c_ifspec;
extern RPC_IF_HANDLE __MIDL_itf_ivssccprovider_0000_v0_0_s_ifspec;
...
HRESULT STDMETHODCALLTYPE IVsSccProvider_SetActive_Proxy( 
    IVsSccProvider * This);


void __RPC_STUB IVsSccProvider_SetActive_Stub(
    IRpcStubBuffer *This,
...
HRESULT STDMETHODCALLTYPE IVsSccProvider_SetInactive_Proxy( 
    IVsSccProvider * This);


void __RPC_STUB IVsSccProvider_SetInactive_Stub(
    IRpcStubBuffer *This,
    IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
...
HRESULT STDMETHODCALLTYPE IVsSccProvider_AnyItemsUnderSourceControl_Proxy( 
    IVsSccProvider * This,
    /* [out] */ BOOL *pfResult);


void __RPC_STUB IVsSccProvider_AnyItemsUnderSourceControl_Stub(
    IRpcStubBuffer *This,
    IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
