...
/* interface __MIDL_itf_ivsscctoolsoptions_0000 */
/* [local] */ 
...
extern RPC_IF_HANDLE __MIDL_itf_ivsscctoolsoptions_0000_v0_0_c_ifspec;
extern RPC_IF_HANDLE __MIDL_itf_ivsscctoolsoptions_0000_v0_0_s_ifspec;
...
EXTERN_C const IID IID_IVsSccToolsOptions;
    ...
    public:
        ...
        virtual HRESULT STDMETHODCALLTYPE GetSccToolsOption( 
            /* [in] */ SccToolsOptionsEnum sctoOptionToBeSet,
            /* [retval][out] */ VARIANT *pvarValueToGet) = 0;
    ...
    typedef struct IVsSccToolsOptionsVtbl
    {
        ...
        HRESULT ( STDMETHODCALLTYPE *GetSccToolsOption )( 
            IVsSccToolsOptions * This,
            /* [in] */ SccToolsOptionsEnum sctoOptionToBeSet,
            /* [retval][out] */ VARIANT *pvarValueToGet);
...
HRESULT STDMETHODCALLTYPE IVsSccToolsOptions_SetSccToolsOption_Proxy( 
    IVsSccToolsOptions * This,
    /* [in] */ SccToolsOptionsEnum sctoOptionToBeSet,
    /* [in] */ VARIANT varValueToBeSet);


void __RPC_STUB IVsSccToolsOptions_SetSccToolsOption_Stub(
    IRpcStubBuffer *This,
...
HRESULT STDMETHODCALLTYPE IVsSccToolsOptions_GetSccToolsOption_Proxy( 
    IVsSccToolsOptions * This,
    /* [in] */ SccToolsOptionsEnum sctoOptionToBeSet,
    /* [retval][out] */ VARIANT *pvarValueToGet);


void __RPC_STUB IVsSccToolsOptions_GetSccToolsOption_Stub(
    IRpcStubBuffer *This,
    IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
...
/* interface __MIDL_itf_ivsscctoolsoptions_0116 */
/* [local] */ 

#define SID_SVsSccToolsOptions IID_SVsSccToolsOptions


extern RPC_IF_HANDLE __MIDL_itf_ivsscctoolsoptions_0116_v0_0_c_ifspec;
extern RPC_IF_HANDLE __MIDL_itf_ivsscctoolsoptions_0116_v0_0_s_ifspec;
