...
/* interface __MIDL_itf_IVsTrackProjectDocumentsEvents80_0000 */
/* [local] */ 
...
extern RPC_IF_HANDLE __MIDL_itf_IVsTrackProjectDocumentsEvents80_0000_v0_0_c_ifspec;
extern RPC_IF_HANDLE __MIDL_itf_IVsTrackProjectDocumentsEvents80_0000_v0_0_s_ifspec;
...
HRESULT STDMETHODCALLTYPE IVsTrackProjectDocumentsEvents3_OnBeginQueryBatch_Proxy( 
    IVsTrackProjectDocumentsEvents3 * This);


void __RPC_STUB IVsTrackProjectDocumentsEvents3_OnBeginQueryBatch_Stub(
    IRpcStubBuffer *This,
...
HRESULT STDMETHODCALLTYPE IVsTrackProjectDocumentsEvents3_OnEndQueryBatch_Proxy( 
    IVsTrackProjectDocumentsEvents3 * This,
    /* [retval][out] */ BOOL *pfActionOK);


void __RPC_STUB IVsTrackProjectDocumentsEvents3_OnEndQueryBatch_Stub(
    IRpcStubBuffer *This,
    IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
...
HRESULT STDMETHODCALLTYPE IVsTrackProjectDocumentsEvents3_OnCancelQueryBatch_Proxy( 
    IVsTrackProjectDocumentsEvents3 * This);


void __RPC_STUB IVsTrackProjectDocumentsEvents3_OnCancelQueryBatch_Stub(
    IRpcStubBuffer *This,
    IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
...
HRESULT STDMETHODCALLTYPE IVsTrackProjectDocumentsEvents3_OnQueryAddFilesEx_Proxy( 
    IVsTrackProjectDocumentsEvents3 * This,
    /* [in] */ IVsProject *pProject,
    /* [in] */ int cFiles,
    /* [size_is][in] */ const LPCOLESTR rgpszNewMkDocuments[  ],
...
void __RPC_STUB IVsTrackProjectDocumentsEvents3_OnQueryAddFilesEx_Stub(
    IRpcStubBuffer *This,
    IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
...
HRESULT STDMETHODCALLTYPE IVsTrackProjectDocumentsEvents3_HandsOffFiles_Proxy( 
    IVsTrackProjectDocumentsEvents3 * This,
    /* [in] */ HANDSOFFMODE grfRequiredAccess,
    /* [in] */ int cFiles,
    /* [size_is][in] */ const LPCOLESTR rgpszMkDocuments[  ]);
...
void __RPC_STUB IVsTrackProjectDocumentsEvents3_HandsOffFiles_Stub(
    IRpcStubBuffer *This,
    IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
...
HRESULT STDMETHODCALLTYPE IVsTrackProjectDocumentsEvents3_HandsOnFiles_Proxy( 
    IVsTrackProjectDocumentsEvents3 * This,
    /* [in] */ int cFiles,
    /* [size_is][in] */ const LPCOLESTR rgpszMkDocuments[  ]);


void __RPC_STUB IVsTrackProjectDocumentsEvents3_HandsOnFiles_Stub(
    IRpcStubBuffer *This,
    IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
