...
/* interface __MIDL_itf_completion_0000 */
/* [local] */ 

#pragma once


extern RPC_IF_HANDLE __MIDL_itf_completion_0000_v0_0_c_ifspec;
extern RPC_IF_HANDLE __MIDL_itf_completion_0000_v0_0_s_ifspec;
...
HRESULT STDMETHODCALLTYPE IVsCommandWindowCompletion_SetCompletionContext_Proxy( 
    IVsCommandWindowCompletion * This,
    /* [in] */ LPCOLESTR pszFilePath,
    /* [in] */ IVsTextLines *pBuffer,
    /* [in] */ const TextSpan *ptsCurStatement,
...
void __RPC_STUB IVsCommandWindowCompletion_SetCompletionContext_Stub(
    IRpcStubBuffer *This,
...
HRESULT STDMETHODCALLTYPE IVsImmediateStatementCompletion_InstallStatementCompletion_Proxy( 
    IVsImmediateStatementCompletion * This,
    /* [in] */ BOOL fInstall,
    /* [in] */ IVsTextView *pCmdWinView,
    /* [in] */ BOOL fInitialEnable);
...
void __RPC_STUB IVsImmediateStatementCompletion_InstallStatementCompletion_Stub(
    IRpcStubBuffer *This,
    IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
...
/* [restricted][hidden] */ HRESULT STDMETHODCALLTYPE IVsImmediateStatementCompletion_EnableStatementCompletion_Deprecated_Proxy( 
    IVsImmediateStatementCompletion * This,
    /* [in] */ BOOL fEnable,
    /* [in] */ CharIndex iStartIndex,
    /* [in] */ CharIndex iEndIndex);
...
void __RPC_STUB IVsImmediateStatementCompletion_EnableStatementCompletion_Deprecated_Stub(
    IRpcStubBuffer *This,
    IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
...
/* [restricted][hidden] */ HRESULT STDMETHODCALLTYPE IVsImmediateStatementCompletion_SetCompletionContext_Deprecated_Proxy( 
    IVsImmediateStatementCompletion * This,
    /* [in] */ LPCOLESTR pszFilePath,
    /* [in] */ IVsTextLines *pBuffer,
    /* [in] */ const TextSpan *ptsCurStatement,
...
void __RPC_STUB IVsImmediateStatementCompletion_SetCompletionContext_Deprecated_Stub(
    IRpcStubBuffer *This,
    IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
...
EXTERN_C const IID IID_IVsImmediateStatementCompletion2;
    ...
    public:
        ...
        virtual HRESULT STDMETHODCALLTYPE GetFilter( 
            ...
            /* [out] */ IVsTextViewFilter **ppFilter) = 0;
...
HRESULT STDMETHODCALLTYPE IVsImmediateStatementCompletion2_EnableStatementCompletion_Proxy( 
    IVsImmediateStatementCompletion2 * This,
    /* [in] */ BOOL fEnable,
    /* [in] */ CharIndex iStartIndex,
    /* [in] */ CharIndex iEndIndex,
...
void __RPC_STUB IVsImmediateStatementCompletion2_EnableStatementCompletion_Stub(
    IRpcStubBuffer *This,
    IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
...
HRESULT STDMETHODCALLTYPE IVsImmediateStatementCompletion2_SetCompletionContext_Proxy( 
    IVsImmediateStatementCompletion2 * This,
    /* [in] */ LPCOLESTR pszFilePath,
    /* [in] */ IVsTextLines *pBuffer,
    /* [in] */ const TextSpan *ptsCurStatement,
...
void __RPC_STUB IVsImmediateStatementCompletion2_SetCompletionContext_Stub(
    IRpcStubBuffer *This,
    IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
...
HRESULT STDMETHODCALLTYPE IVsImmediateStatementCompletion2_GetFilter_Proxy( 
    IVsImmediateStatementCompletion2 * This,
    /* [in] */ IVsTextView *pTextView,
    /* [out] */ IVsTextViewFilter **ppFilter);


void __RPC_STUB IVsImmediateStatementCompletion2_GetFilter_Stub(
    IRpcStubBuffer *This,
    IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
