...
/* interface __MIDL_itf_dpkg_0000 */
/* [local] */ 
...
extern RPC_IF_HANDLE __MIDL_itf_dpkg_0000_v0_0_c_ifspec;
extern RPC_IF_HANDLE __MIDL_itf_dpkg_0000_v0_0_s_ifspec;
...
EXTERN_C const IID IID_IVsSolutionDebuggingAssistant2;
    ...
    public:
        virtual HRESULT STDMETHODCALLTYPE MapOutputToDeployedURLs( 
            ...
            /* [in] */ ULONG celt,
            /* [size_is][out][in] */ BSTR rgbstrMachines[  ],
            /* [size_is][out][in] */ BSTR rgbstrURLs[  ],
            /* [out] */ ULONG *pcActual) = 0;
...
HRESULT STDMETHODCALLTYPE IVsSolutionDebuggingAssistant2_MapOutputToDeployedURLs_Proxy( 
    IVsSolutionDebuggingAssistant2 * This,
    /* [in] */ DWORD dwReserved,
    /* [in] */ IVsProjectCfg *pProjectCfg,
    /* [in] */ LPCOLESTR pszOutputCanonicalName,
...
void __RPC_STUB IVsSolutionDebuggingAssistant2_MapOutputToDeployedURLs_Stub(
    IRpcStubBuffer *This,
...
HRESULT STDMETHODCALLTYPE IVsSolutionDebuggingAssistant2_MapDeployedURLToProjectItem_Proxy( 
    IVsSolutionDebuggingAssistant2 * This,
    /* [in] */ DWORD dwReserved,
    /* [in] */ LPCOLESTR pszDUrl,
    /* [out] */ IVsHierarchy **pphier,
...
void __RPC_STUB IVsSolutionDebuggingAssistant2_MapDeployedURLToProjectItem_Stub(
    IRpcStubBuffer *This,
    IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
...
EXTERN_C const IID IID_IVsProvideDebuggingInfo;
    ...
    public:
        virtual HRESULT STDMETHODCALLTYPE GetDeployedOutputs( 
            /* [in] */ ULONG celt,
            /* [size_is][out][in] */ IVsHierarchy *pIVsHierarchy[  ],
            /* [size_is][out][in] */ IVsProjectCfg *pIVsProjectCfg[  ],
            /* [size_is][out][in] */ IVsOutput *pIVsOutput[  ],
            /* [size_is][out][in] */ BSTR rgbstrMachines[  ],
            /* [size_is][out][in] */ BSTR rgbstrURLs[  ],
            /* [out] */ ULONG *pcActual) = 0;
...
HRESULT STDMETHODCALLTYPE IVsProvideDebuggingInfo_GetDeployedOutputs_Proxy( 
    IVsProvideDebuggingInfo * This,
    /* [in] */ ULONG celt,
    /* [size_is][out][in] */ IVsHierarchy *pIVsHierarchy[  ],
    /* [size_is][out][in] */ IVsProjectCfg *pIVsProjectCfg[  ],
...
void __RPC_STUB IVsProvideDebuggingInfo_GetDeployedOutputs_Stub(
    IRpcStubBuffer *This,
    IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
