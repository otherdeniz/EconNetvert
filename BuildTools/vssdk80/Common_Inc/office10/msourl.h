...
typedef enum
	...
	urlrAbsolute,         // EXAMPLE: "http://foobar.com/woo.hoo"
...
DECLARE_INTERFACE_(IMsoUrl, IUnknown)
{
	...
	//    WzLocalPath.
	//
	// EXAMPLE 1: "file://c:/foobar/woo.hoo" yields "c:\foobar\woo.hoo".
	// EXAMPLE 2: "file://server/share/foobar/woo.hoo" yields "\\server\share\foobar\woo.hoo".
	...
	//
	// EXAMPLE 1: "http://foobar/woo/blah.htm" subsumes "http://foobar/woo/hoo/wunder.bar".
	// EXAMPLE 2: "http://foobar/woo/hoo/wunder.bar" does not subsume "http://foobar/woo/blah.htm".
	// EXAMPLE 3: "http://foobar/woo/blah.htm" does not subsume "ftp://foobarbaz/woo/hoo/wunder.bar".
	// EXAMPLE 4: "http://foobar/woo/hoo/blah.htm" does not subsume "http://foobar/woo/zoo/foo.gif".
	...
	//    rebased with new base "http://foobar/spiffy.htm"
