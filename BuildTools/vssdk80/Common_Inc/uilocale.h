...
/* interface __MIDL_itf_uilocale_0000 */
/* [local] */ 
...
extern RPC_IF_HANDLE __MIDL_itf_uilocale_0000_v0_0_c_ifspec;
extern RPC_IF_HANDLE __MIDL_itf_uilocale_0000_v0_0_s_ifspec;
...
EXTERN_C const IID IID_IUIHostLocale;
    ...
    public:
        virtual HRESULT STDMETHODCALLTYPE GetUILocale( 
            /* [retval][out] */ LCID *plcid) = 0;
        
        virtual HRESULT STDMETHODCALLTYPE GetDialogFont( 
            /* [out] */ UIDLGLOGFONT *plogfont) = 0;
...
HRESULT STDMETHODCALLTYPE IUIHostLocale_GetUILocale_Proxy( 
    IUIHostLocale * This,
    /* [retval][out] */ LCID *plcid);


void __RPC_STUB IUIHostLocale_GetUILocale_Stub(
    IRpcStubBuffer *This,
...
HRESULT STDMETHODCALLTYPE IUIHostLocale_GetDialogFont_Proxy( 
    IUIHostLocale * This,
    /* [out] */ UIDLGLOGFONT *plogfont);


void __RPC_STUB IUIHostLocale_GetDialogFont_Stub(
    IRpcStubBuffer *This,
    IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
...
EXTERN_C const IID IID_IUIHostLocale2;
    ...
    public:
        virtual HRESULT STDMETHODCALLTYPE LoadUILibrary( 
            ...
            /* [in] */ DWORD dwExFlags,
            /* [retval][out] */ DWORD_PTR *phinstOut) = 0;
        
        virtual HRESULT STDMETHODCALLTYPE MungeDialogFont( 
            /* [in] */ DWORD dwSize,
            /* [size_is][in] */ const BYTE *pDlgTemplate,
            /* [out] */ BYTE **ppDlgTemplateOut) = 0;
        
        virtual HRESULT STDMETHODCALLTYPE LoadDialog( 
            /* [in] */ DWORD_PTR hMod,
            /* [in] */ DWORD dwDlgResId,
            /* [out] */ BYTE **ppDlgTemplate) = 0;
    ...
    typedef struct IUIHostLocale2Vtbl
    {
        ...
        HRESULT ( STDMETHODCALLTYPE *LoadUILibrary )( 
            ...
            /* [in] */ LPCOLESTR lpstrDllName,
            /* [in] */ DWORD dwExFlags,
            /* [retval][out] */ DWORD_PTR *phinstOut);
...
HRESULT STDMETHODCALLTYPE IUIHostLocale2_LoadUILibrary_Proxy( 
    IUIHostLocale2 * This,
    /* [in] */ LPCOLESTR lpstrPath,
    /* [in] */ LPCOLESTR lpstrDllName,
    /* [in] */ DWORD dwExFlags,
...
void __RPC_STUB IUIHostLocale2_LoadUILibrary_Stub(
    IRpcStubBuffer *This,
    IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
...
HRESULT STDMETHODCALLTYPE IUIHostLocale2_MungeDialogFont_Proxy( 
    IUIHostLocale2 * This,
    /* [in] */ DWORD dwSize,
    /* [size_is][in] */ const BYTE *pDlgTemplate,
    /* [out] */ BYTE **ppDlgTemplateOut);
...
void __RPC_STUB IUIHostLocale2_MungeDialogFont_Stub(
    IRpcStubBuffer *This,
    IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
...
HRESULT STDMETHODCALLTYPE IUIHostLocale2_LoadDialog_Proxy( 
    IUIHostLocale2 * This,
    /* [in] */ DWORD_PTR hMod,
    /* [in] */ DWORD dwDlgResId,
    /* [out] */ BYTE **ppDlgTemplate);
...
void __RPC_STUB IUIHostLocale2_LoadDialog_Stub(
    IRpcStubBuffer *This,
    IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
...
HRESULT STDMETHODCALLTYPE IUIHostLocale2_GetUILibraryFileName_Proxy( 
    IUIHostLocale2 * This,
    /* [in] */ LPCOLESTR lpstrPath,
    /* [in] */ LPCOLESTR lpstrDllName,
    /* [retval][out] */ BSTR *pbstrOut);
...
void __RPC_STUB IUIHostLocale2_GetUILibraryFileName_Stub(
    IRpcStubBuffer *This,
    IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
...
/* interface __MIDL_itf_uilocale_0118 */
/* [local] */ 

#define SID_SUIHostLocale IID_IUIHostLocale


extern RPC_IF_HANDLE __MIDL_itf_uilocale_0118_v0_0_c_ifspec;
extern RPC_IF_HANDLE __MIDL_itf_uilocale_0118_v0_0_s_ifspec;
