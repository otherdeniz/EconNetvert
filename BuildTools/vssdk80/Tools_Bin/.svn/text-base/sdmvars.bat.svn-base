...
set VSRegKey=HKLM\Software\Microsoft\VisualStudio\8.0
if defined PROGRAMFILES(x86) SET VSRegKey=HKLM\Software\Wow6432Node\Microsoft\VisualStudio\8.0
...
REG QUERY "%VSRegKey%" /v InstallDir > "%SdmTempQueryFile%" 2>null
...
if not exist "%SdmModelsDirCheck%" echo Warning: The SDM Command Prompt cannot be initialized because Visual Studio 2005 Team Edition for Architects is not installed. To launch the SDM Command Prompt, Visual Studio 2005 Team Edition for Architects must be installed. & goto :CLEANUP
